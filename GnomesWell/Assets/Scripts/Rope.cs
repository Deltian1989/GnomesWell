...
public class Rope : MonoBehaviour
{
    ...
    {
        GameObject segment = (GameObject)Instantiate(ropeSegmentPrefab, transform.position, Quaternion.identity);
        ...
        {
            Debug.LogError("Prefabrykat  segmentu liny nie ma obiektu Rigidbody2D i SpringJoint2D");
            return;
        }
